package com.clock.demo.security;

import com.clock.demo.common.UserLoginAuthenticationFailureHandler;
import com.clock.demo.common.UserLoginAuthenticationSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http.authorizeRequests()
                .antMatchers("/record/*","/activity/*","/","/StockIn/*").permitAll()
